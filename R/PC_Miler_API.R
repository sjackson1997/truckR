...
# GET Examples ----
req <- c("?stops=-75.173297%2C39.942892%3B-74.83153%2C39.61703%3B-74.438942%2C39.362469&reports=Mileage",
...
pcm_POST <- function(df, lst_origins = lst_origins,
	...
	pcm_response <- POST(url = route_url_post,
...
pcm_process_request <- function(lst){
	...
	df_routes <- do.call(rbind, lapply(seq_along(lst_to_process),
																		 function(x) {
																		 	cat(paste0("\033[0;36mThere are \033[0;41m",
